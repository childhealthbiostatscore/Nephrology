...
vars_3 <- c("ID_NTMX_pre", "ID_NTMX_post", "count_NTMX_pre", "count_NTMX_post", "time_flag_to_peak", "supra_NTMX_pre", "vaso_pre")

# List of non-normal variables for the table
nonnormal_vars <- c("ID_NTMX_pre", "ID_NTMX_post", "count_NTMX_pre", "count_NTMX_post", "time_flag_to_peak", "supra_NTMX_pre", "vaso_pre")
