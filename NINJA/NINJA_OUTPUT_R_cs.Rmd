...
# should be similar to use for alluvial purposes
data_day_exp <- read.csv("S:/Brinton/Nephrology/2024.03.06 Shih NINJA - RAI mephrotoxin exposures in ICU and clincal course retrospective cohort/data/dde.csv")
